...
const reviewedTheoryPages = {
  ...
  'classical-mechanics': ['Generalized coordinates describe the allowed configuration space', 'Normal modes are a local harmonic construction'],
  ...
  'thermodynamics': ['A thermodynamic state requires declared variables', 'Zero-temperature electronic energy is one ingredient, not every free energy'],
