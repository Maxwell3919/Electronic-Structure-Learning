    ...
    "entries": [
      {
        ...
        "whyUse": "Use it for the reported computational method, approximation, or design strategy and its stated scope.",
        "boundary": "Reported performance remains tied to the tested systems, approximation stack, and validation design."
      },
      {
    ...
    "entries": [
      {
        ...
        "whyUse": "Use it as a case study of lattice response, electron–phonon coupling, or superconducting evidence in the stated system.",
        "boundary": "Coupling, soft modes, or a predicted transition remain model- and convergence-dependent and are not interchangeable evidence."
      },
      {
    ...
    "entries": [
      {
        ...
        "whyUse": "Use it for a concrete symmetry, Wannier, Berry, or topological analysis in the stated material model.",
        "boundary": "The conclusion depends on the stated symmetry, gap, subspace, gauge handling, and Hamiltonian choices."
      },
      {
    ...
    "entries": [
      {
        ...
        "whyUse": "Use it as a bounded material or interface case study linked to the relevant Atlas concepts.",
        "boundary": "Conclusions remain tied to the reported structure, approximation stack, convergence evidence, and observable."
      },
      {
